...
We use certified payments processing vendors such as [Flip (Indonesia)](https://flip.id), [DOKU (Indonesia)](https://doku.com), [PayPal Holdings, Inc.](https://paypal.com) to enable them to process your payment.
...
If you have questions regarding how your payment data is handled, please refer to [Flip.id Privacy Policy](https://flip.id/en/kebijakan-privasi), [DOKU Privacy Policy](https://doku.com/kebijakan-privasi), and [PayPal Privacy Policy](http://paypal.com/privacy) for more information how they process personal information related to payments.
